      ...
      {query.isSuccess && (
        <View style={{ padding: 0 }}>
          <AppView style={{ flexDirection: 'row', paddingHorizontal: 8, width: '100%' }}>
            <AppText style={{ flex: 1, fontFamily: 'SkModernistBold' }}>Public Key</AppText>
            <AppText style={{ flex: 1, fontFamily: 'SkModernistBold' }}>Mint</AppText>
            <AppText style={{ flex: 1, fontFamily: 'SkModernistBold', textAlign: 'right' }}>Balance</AppText>
          </AppView>
          {query.data.length === 0 && (
